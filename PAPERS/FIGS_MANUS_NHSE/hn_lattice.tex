...
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=0.76 ] (277.15,71.93) .. controls (277.15,65.34) and (282.49,60) .. (289.07,60) .. controls (295.66,60) and (301,65.34) .. (301,71.93) .. controls (301,78.51) and (295.66,83.85) .. (289.07,83.85) .. controls (282.49,83.85) and (277.15,78.51) .. (277.15,71.93) -- cycle ;
%Straight Lines [id:da6300638154973164] 
\draw    (301,71.93) -- (341.68,72.12) ;
%Shape: Circle [id:dp9264939026993823] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=0.76 ] (342.15,71.93) .. controls (342.15,65.34) and (347.49,60) .. (354.07,60) .. controls (360.66,60) and (366,65.34) .. (366,71.93) .. controls (366,78.51) and (360.66,83.85) .. (354.07,83.85) .. controls (347.49,83.85) and (342.15,78.51) .. (342.15,71.93) -- cycle ;
%Straight Lines [id:da9201072853916674] 
\draw    (366,71.93) -- (406.68,72.12) ;
%Shape: Circle [id:dp6666759085430102] 
\draw  [fill={rgb, 255:red, 80; green, 227; blue, 194 }  ,fill opacity=0.76 ] (407.15,71.93) .. controls (407.15,65.34) and (412.49,60) .. (419.07,60) .. controls (425.66,60) and (431,65.34) .. (431,71.93) .. controls (431,78.51) and (425.66,83.85) .. (419.07,83.85) .. controls (412.49,83.85) and (407.15,78.51) .. (407.15,71.93) -- cycle ;
...
% Text Node
\draw (152,69.8) node [anchor=north west][inner sep=0.75pt]    {$\dotsc $};
% Text Node
% Text Node
\draw (475,70.3) node [anchor=north west][inner sep=0.75pt]    {$\dotsc $};
% Text Node
